...
# Global variables to hold models, scaler, and feature names
model_views = None
model_likes = None
model_comments = None
model_shares = None
model_subscribers = None
scaler = None
feature_names = None
...
def train_and_save_models():
    ...
    global model_views, model_likes, model_comments, model_shares, model_subscribers
...
def load_models_and_scaler():
    global feature_names, model_views, model_likes, model_comments, model_shares, model_subscribers, scaler
