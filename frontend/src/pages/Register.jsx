  ...
  return (
    <>
      <section className="register-page">
        <div className="content-wrapper">
          <div className="info-container">
            ...
            <p>
            Not sure if MPC, BiPC, or another stream is right for you after 10th grade? Join us to unlock tailored career advice and explore your options with clarity. Connect with experts and chart a confident path to your future!
            </p>
            <img
                ...
                <div className="form-group">
                  ...
                  <div className="input-wrapper">
                    ...
                    >
                      ...
                      <option value="Employer">Register as a College admin</option>
                ...
                <>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => setacademicDetails_Overall(e.target.value)}
                    />
      ...
      <style jsx>{`
        ...
        .info-container {
          position: fixed; /* Fixed positioning to keep it in place while scrolling */
        ...
        .register-container {
          margin-left: 340px; /* Adjust space for the fixed info-container */
          background: white;
          padding: 40px;
          border-radius: 10px;
